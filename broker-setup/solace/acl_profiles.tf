# ------------------------------------------------------------------------------
# Terraform configuration for creating ACL profiles in Solace Message Broker.
# ACL (Access Control List) profiles define the permissions for different 
# services interacting with the broker.
# ------------------------------------------------------------------------------
